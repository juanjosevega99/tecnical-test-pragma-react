        ...
        <div className="panel" style={this.state.style[0]}>
          <div className="panel-heading">
            <div className="row">
              ...
              <div className="col-md-6">
                <span className="pull-right">
                  <a
                    href="#"
                    onClick={this.editNote.bind(this, this.props.note.id)}
                  >
                  ...
                  <a
                    href="#"
                    onClick={this.deleteNote.bind(this, this.props.note.id)}
                  >
                    <button className="btn btn-default btn-xs" type="submit">
                      <span
            ...
            >
              ...
              <div className="btn-group" role="group">
                <button
                  onClick={this.orangeLabelClick}
                  type="button"
                  className="btn btn-warning btn-xs"
                ></button>
              </div>
            </div>
            <p style={labelInfoStyle}>
              <b>@{this.state.style[0].labelName}</b> | #
              {this.state.style[0].labelColor}
            </p>
          </div>
        </div>
      </div>
