...
class ColonItem extends Component {
  ...
  saveJson() {
    var data =
      ...
      encodeURIComponent(JSON.stringify(this.props.colon.notes, null, 2));
    if (this.props.colon.notes.length > 0) {
      $("#download").empty();
      $(
        '<a href="data:' +
          data +
          '" download="data.json" title="Download all notes as JSON">JSON</a>'
      ).appendTo("#download");
    }
  }
            ...
            <div className="panel-heading">
              <div className="row" style={colonStyle}>
                <div className="col-md-6">
                  <h4 className="pull-left" style={titleStyle}>
                    {this.props.colon.title}
                  </h4>
                </div>
                <div className="col-md-6">
                  <span className="pull-right">
                    ...
                    <a
                      href="#"
                      onClick={this.deleteColon.bind(
                        this,
                        this.props.colon.colonId
                      )}
                    >
                      <button
                        className="btn btn-default btn-xs"
                ...
                <Notes
                  notes={this.props.colon.notes}
                  onDelete={this.handleDeleteNote.bind(this)}
                  onEdit={this.handleEditNote.bind(this)}
                />
